...
module.exports = function(jQuery, ServerVars, document) {
  ...
  (function(a) {
    ...
    bungieNetPlatform.userService = {
      ...
      GetBungieAccount: function(membershipId, membershipType, successCallback, errorCallback, d) {
        var b = bungieNetPlatform.platformSettings.platformUrl + "/User/GetBungieAccount/" + encodeURIComponent(membershipId) + "/" + encodeURIComponent(membershipType) + "/",
            e = "?lc=" + bungieNetPlatform.platformSettings.currentLocale + "&fmt=true&lcin=" + bungieNetPlatform.platformSettings.locInherit;
        if (typeof d !== "undefined") e += d;
        b = b + e;
        var c = bungieNetPlatform.userService.userData.getCacheItem(b);
  ...
  (function(a) {
    bungieNetPlatform.destinyService = {
      ...
      GetDestinyManifest: function(successCallback, errorCallback, d) {
      ...
      GetAccount: function(membershipType, membershipId, definitions, successCallback, errorCallback, c) {
        var a = bungieNetPlatform.platformSettings.platformUrl + "/Destiny/" + encodeURIComponent(membershipType) + "/Account/" + encodeURIComponent(membershipId) + "/",
            b = "?lc=" + bungieNetPlatform.platformSettings.currentLocale + "&fmt=true&lcin=" + bungieNetPlatform.platformSettings.locInherit;
      ...
      GetCharacterSummary: function(membershipType, membershipId, characterId, definitions, h, i, c) {
        var a = bungieNetPlatform.platformSettings.platformUrl + "/Destiny/" + encodeURIComponent(membershipType) + "/Account/" + encodeURIComponent(membershipId) + "/Character/" + encodeURIComponent(characterId) + "/",
            b = "?lc=" + bungieNetPlatform.platformSettings.currentLocale + "&fmt=true&lcin=" + bungieNetPlatform.platformSettings.locInherit;
        b += "&definitions=" + encodeURIComponent(definitions);
        if (typeof c !== "undefined") b += c;
        a = a + b;
      ...
      GetCharacter: function(membershipType, membershipId, characterId, definitions, successCallback, errorCallback, c) {
        var a = bungieNetPlatform.platformSettings.platformUrl + "/Destiny/" + encodeURIComponent(membershipType) + "/Account/" + encodeURIComponent(membershipId) + "/Character/" + encodeURIComponent(characterId) + "/Complete/",
            b = "?lc=" + bungieNetPlatform.platformSettings.currentLocale + "&fmt=true&lcin=" + bungieNetPlatform.platformSettings.locInherit;
        b += "&definitions=" + encodeURIComponent(definitions);
        if (typeof c !== "undefined") b += c;
        a = a + b;
      ...
      GetCharacterInventory: function(membershipType, membershipId, characterId, definitions, h, i, c) {
        var a = bungieNetPlatform.platformSettings.platformUrl + "/Destiny/" + encodeURIComponent(membershipType) + "/Account/" + encodeURIComponent(membershipId) + "/Character/" + encodeURIComponent(characterId) + "/Inventory/",
            b = "?lc=" + bungieNetPlatform.platformSettings.currentLocale + "&fmt=true&lcin=" + bungieNetPlatform.platformSettings.locInherit;
        b += "&definitions=" + encodeURIComponent(definitions);
        if (typeof c !== "undefined") b += c;
        a = a + b;
